...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          <label for="price" class="col-form-label">Price(EUR) <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="inputMagazine" class="col-form-label">Magazine <span class="text-danger"></span></label>
          <div class="input-group">
              <span class="input-group-btn">
              <input type="file" id="magazineUpload" name="magazine_file" accept="application/pdf" class="form-control mt-2">

              </span>
             
          </div>
      </div>
      <div id="magazine-holder" style="margin-top:15px;max-height:100px;"></div>
          @error('magazine')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
