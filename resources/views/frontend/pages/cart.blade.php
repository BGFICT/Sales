								...
								@if(Helper::getAllProductFromCart())
									@foreach(Helper::getAllProductFromCart() as $key=>$cart)
										<tr>
											...
											<td class="price" data-title="Price" id="order_total_price" data-price="{{ $cart['price']}}"><span>${{number_format($cart['price'],2)}}</span></td>
											...
											<td class="total-amount cart_single_price" id="order_total_price" data-price="{{ $cart['amount'] }}"> data-title="Total"><span class="money">${{$cart['amount']}}</span></td>
					...
					<div class="total-amount">
						<div class="row">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">Cart Subtotal<span id="order_subtotal" data-price="{{Helper::totalCartPrice()}}">${{number_format(Helper::totalCartPrice(),2)}}</span></li>
										...
										{{-- && session()->has('shipping')) --}}
											<li class="last" id="order_total_price" >You Pay<span id="order_total_price" data-price="{{$total_amount}}">${{number_format($total_amount,2)}}</span></li>
