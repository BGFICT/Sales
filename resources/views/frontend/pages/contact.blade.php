						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									@endphp
									<h4 style="color: #6fae2d">Get in touch</h4>
						...
						<div class="col-lg-4 col-12">
							<div class="single-head">
								<div class="single-info">
									<i class="fa fa-phone" style="background: #6fae2d"></i>
								...
								<div class="single-info">
									<i class="fa fa-envelope-open"  style="background: #6fae2d"></i>
								...
								<div class="single-info">
									<i class="fa fa-location-arrow"  style="background: #6fae2d"></i>
