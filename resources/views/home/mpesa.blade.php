...
<<<<<<< HEAD
                  <input type="text" id="order_total_price1" style="display:none;" data-price="{{ $total_amount }}" class="form-control" name="amount" placeholder="Enter Amount"> 
=======
...
>>>>>>> 24d5f63bd6df7702583ee779b8cacfb38024a7e5
                ...
                <div class="col-12">
<<<<<<< HEAD
                  {{-- @if(in_array($countries, ['United States', 'South Africa'])) --}}
                      <button type="submit" class="btn btn-success" id="order_total_price" data-price="{{ $total_amount }}" name="submit" value="submit">
                          Pay {{ $total_amount }}
                      </button>
                  {{-- @elseif(in_array($countries, ['Spain', 'Norway', 'Germany', 'Finland', 'Switzerland']))
                      <button type="submit" class="btn btn-success" id="order_total_price" data-price="{{ $total_amount * 125.68 }}" name="submit" value="submit">
                          Pay {{ $total_amount }}
                      </button>
                  @elseif($countries == 'Kenya')
                      <button type="submit" class="btn btn-success" id="order_total_price" data-price="{{ $total_amount }}" name="submit" value="submit">
                          Pay {{ $total_amount }}
                      </button>
                  @endif --}}
